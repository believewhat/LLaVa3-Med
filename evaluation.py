...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        if line["conversations"][1]["value"] == 'yes' or line["conversations"][1]["value"] == 'no':
            prompt = prompt.replace('Correct Answer:', 'Only return yes or no. Correct Answer:').replace("<image>\n", "")
